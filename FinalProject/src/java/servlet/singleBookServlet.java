...
public class singleBookServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String getBook, sql=null;
        getBook=request.getParameter("param");  
        sql="select * from product where picture='"+getBook+"' or productname='"+getBook+"'";

        dbConnection productList = new dbConnection();
        ResultSet rs = null;
        rs = productList.query(sql);
        
        List<Production> thisBook=new ArrayList<>();
        thisBook=ProductionService.showAllProduction(rs); 
